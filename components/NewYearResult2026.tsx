...
export default function NewYearResult2026({
  ...
  const handleDownloadHtml = () => {
    ...
    const htmlContent = `
      ...
      ${createFortuneSection('💍', '결혼운', fortuneCategories.marriage, marriageData.grade, marriageData.summary, marriageData.detail, marriageData.advice, (marriageData as {luckyMonths?: string}).luckyMonths || (marriageData as {goodMonths?: string}).goodMonths, (marriageData as {unluckyMonths?: string}).unluckyMonths || (marriageData as {badMonths?: string}).badMonths)}
      ...
      ${createFortuneSection('💪', '건강운', fortuneCategories.health, healthData.grade, healthData.summary, healthData.detail, healthData.advice, healthData.goodMonths, healthData.badMonths)}
      ${createFortuneSection('📚', '학업운', fortuneCategories.study, studyData.grade, studyData.summary, studyData.detail, studyData.advice, (studyData as {luckyMonths?: string}).luckyMonths || (studyData as {goodMonths?: string}).goodMonths, (studyData as {unluckyMonths?: string}).unluckyMonths || (studyData as {badMonths?: string}).badMonths)}
      ${createFortuneSection('👨‍👩‍👧', '가정운', fortuneCategories.family, familyData.grade, familyData.summary, familyData.detail, familyData.advice, (familyData as {luckyMonths?: string}).luckyMonths || (familyData as {goodMonths?: string}).goodMonths, (familyData as {unluckyMonths?: string}).unluckyMonths || (familyData as {badMonths?: string}).badMonths)}
      ${createFortuneSection('👥', '대인관계운', fortuneCategories.social, socialData.grade, socialData.summary, socialData.detail, socialData.advice, (socialData as {luckyMonths?: string}).luckyMonths || (socialData as {goodMonths?: string}).goodMonths, (socialData as {unluckyMonths?: string}).unluckyMonths || (socialData as {badMonths?: string}).badMonths)}
