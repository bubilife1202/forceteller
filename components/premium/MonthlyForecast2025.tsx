...
interface MonthlyForecast2025Props {
  result: SajuResult;
}

export default function MonthlyForecast2025({ result }: MonthlyForecast2025Props) {
  // 2025년 월별 간지 데이터
  const months2025 = [
    { month: 1, name: '1월 (정월)', stemKo: '무', stemCn: '戊', branchKo: '인', branchCn: '寅', stemElem: '토', branchElem: '목' },
    { month: 2, name: '2월', stemKo: '기', stemCn: '己', branchKo: '묘', branchCn: '卯', stemElem: '토', branchElem: '목' },
    { month: 3, name: '3월', stemKo: '경', stemCn: '庚', branchKo: '진', branchCn: '辰', stemElem: '금', branchElem: '토' },
    { month: 4, name: '4월', stemKo: '신', stemCn: '辛', branchKo: '사', branchCn: '巳', stemElem: '금', branchElem: '화' },
    { month: 5, name: '5월', stemKo: '임', stemCn: '壬', branchKo: '오', branchCn: '午', stemElem: '수', branchElem: '화' },
    { month: 6, name: '6월', stemKo: '계', stemCn: '癸', branchKo: '미', branchCn: '未', stemElem: '수', branchElem: '토' },
    { month: 7, name: '7월', stemKo: '갑', stemCn: '甲', branchKo: '신', branchCn: '申', stemElem: '목', branchElem: '금' },
    { month: 8, name: '8월', stemKo: '을', stemCn: '乙', branchKo: '유', branchCn: '酉', stemElem: '목', branchElem: '금' },
    { month: 9, name: '9월', stemKo: '병', stemCn: '丙', branchKo: '술', branchCn: '戌', stemElem: '화', branchElem: '토' },
    { month: 10, name: '10월', stemKo: '정', stemCn: '丁', branchKo: '해', branchCn: '亥', stemElem: '화', branchElem: '수' },
    { month: 11, name: '11월', stemKo: '무', stemCn: '戊', branchKo: '자', branchCn: '子', stemElem: '토', branchElem: '수' },
    { month: 12, name: '12월', stemKo: '기', stemCn: '己', branchKo: '축', branchCn: '丑', stemElem: '토', branchElem: '토' },
  ];
  ...
  // 월별 운세 평가
  const evaluateMonth = (monthData: typeof months2025[0]) => {
    let score = 50; // 기본 점수
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-slate-300 mb-12 leading-relaxed">
        2025년 을사년(乙巳年)의 월별 운세를 상세히 분석합니다.
        <br />
        매달의 흐름을 미리 알고 준비하면 기회를 놓치지 않고 위험을 피할 수 있습니다.
      </p>

      {/* 월별 상세 분석 */}
      <div className="space-y-6">
        {months2025.map((monthData, index) => {
      ...
      <div className="mt-12 glass rounded-2xl p-6 border border-purple-400/30">
        ...
        <div className="space-y-3 text-slate-300 text-sm">
          ...
          <p className="flex items-start gap-2">
            <span className="text-purple-400 flex-shrink-0">•</span>
            <span>
              <strong className="text-red-400">주의가 필요한 달</strong>:{' '}
              {months2025
                .map((m, i) => ({ ...m, eval: evaluateMonth(m), index: i }))
          ...
          <p className="flex items-start gap-2">
            <span className="text-purple-400 flex-shrink-0">•</span>
            <span>
              2025년은 <strong>을사년(乙巳年)</strong>으로, 을목(乙木)과 사화(巳火)의 기운이
              작용합니다. 당신의 일간 {result.day.stem.ko}{result.day.stem.cn}과의 관계를
              파악하고 한 해를 준비하세요.
            </span>
          </p>
          <p className="flex items-start gap-2">
            <span className="text-purple-400 flex-shrink-0">•</span>
            <span>
              월운은 참고용이며, 실제로는 <strong>일운(날짜)</strong>과{' '}
              <strong>시운(시간)</strong>도 영향을 줍니다. 중요한 일은 좋은 날과 좋은
              시간을 택일하세요.
            </span>
          </p>
        </div>
