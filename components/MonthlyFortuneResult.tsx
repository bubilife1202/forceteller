...
import { downloadElementAsHtml, sendByEmail, createSectionHtml, createScoreBadgeHtml, createProgressBarHtml, createGridHtml, createCardHtml, createListHtml, createMessageBoxHtml } from '@/lib/utils/export-utils';
...
export default function MonthlyFortuneResult({ formData, onReset, onBack, onHome }: MonthlyFortuneResultProps) {
  ...
  const handleDownloadHtml = () => {
    downloadElementAsHtml('monthly-fortune-result', `월간운세_2026년_${targetMonth}월_${userDayStem.ko}일간`);
  };
