...
interface TomorrowFortuneFormProps {
  onSubmit: (data: TomorrowFortuneFormData) => void;
  onBack: () => void;
}

export default function TomorrowFortuneForm({ onSubmit, onBack }: TomorrowFortuneFormProps) {
    ...
    >
      <div className="max-w-md mx-auto">
        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <p className="text-purple-400">{tomorrowStr}</p>
        </motion.div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-slate-800/80 border border-slate-600 rounded-xl text-white focus:outline-none focus:border-purple-400 transition-colors"
              >
