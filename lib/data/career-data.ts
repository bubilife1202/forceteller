...
// 일간별 직업 적성 (확장판)
export const DAY_STEM_CAREER: Record<string, CareerProfile> = {
  '갑': {
    element: '목(木)',
...
// 십성별 직업운
export const TEN_GOD_CAREER: Record<string, TenGodCareer> = {
  '비견': {
    type: '협력과 경쟁',
...
// 현재 시기 직업운
export const YEAR_FORTUNE: Record<string, YearFortune> = {
  '비견': {
